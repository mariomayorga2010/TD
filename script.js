...
--------------------------------------------------------- */
const nodes = [
  { col:0,  lane:"solicitante", type:"start",    phase:1, label:"Necesidad detectada",
    title:"Se identifica la necesidad del servicio",
    desc:"El área solicitante detecta que requiere contratar un servicio." },
  { col:1,  lane:"solicitante", type:"task",     phase:1, label:"Generar Solicitud de Pedido",
    title:"Generar Solicitud de Pedido",
    desc:"Se elabora en SAP o en el formato interno correspondiente." },
  { col:2,  lane:"solicitante", type:"decision", phase:1, label:"¿Cédula de aprobación?",
    ...
    selfLoop:true },
  { col:3,  lane:"solicitante", type:"task",     phase:1, label:"Adjuntar Cédula de Aprobación",
    title:"Adjuntar la Cédula de Aprobación",
    desc:"Se integra al expediente de la solicitud." },
  { col:4,  lane:"solicitante", type:"task",     phase:1, label:"Enviar a Compras",
  ...
  { col:12, lane:"solicitante", type:"decision", phase:3, label:"¿Recibido conforme?",
    ...
    loopTo:11 },
  { col:13, lane:"solicitante", type:"task", phase:3, label:"Registrar evidencia",
  ...
  { col:14, lane:"proveedor", type:"task", phase:4, label:"Enviar factura",
    title:"El proveedor envía factura",
    desc:"La factura se remite para su validación." },
  { col:15, lane:"responsable", type:"decision", phase:4, label:"¿Factura coincide?",
  ...
  { col:24, lane:"solicitante", type:"task", phase:8, label:"Enviar constancia firmada",
    title:"Enviar constancia firmada al proveedor",
    desc:"Se remite el documento firmado como cierre del ciclo (por el solicitante o Cuentas por Pagar)." },
  { col:25, lane:"solicitante", type:"decision", phase:8, label:"¿Confirma recepción?",
    ...
    loopTo:24 },
  { col:26, lane:"solicitante", type:"end", phase:8, label:"Proceso finalizado",
